  ...
  return userData && (
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      <div className='mt-10'>
        {
          isEdit
          ?<button className='border border-primary-custom px-8 py-2 rounded-full hover:bg-primary-custom hover:text-white transition-all' onClick={updateUserProfile}>Save information</button>
